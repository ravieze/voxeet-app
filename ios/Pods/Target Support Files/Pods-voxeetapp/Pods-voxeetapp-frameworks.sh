...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EXApplication/EXApplication.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXConstants/EXConstants.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXErrorRecovery/EXErrorRecovery.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXFont/EXFont.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXImageLoader/EXImageLoader.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/EXSplashScreen/EXSplashScreen.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/UMAppLoader/UMAppLoader.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UMPermissionsInterface/UMPermissionsInterface.framework"
  install_framework "${PODS_ROOT}/VoxeetSDK/VoxeetSDK.framework"
  install_framework "${PODS_ROOT}/VoxeetSDK/WebRTC.framework"
  install_framework "${PODS_ROOT}/VoxeetSDK/dvclient.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/VoxeetUXKit/VoxeetUXKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Yoga/yoga.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/glog/glog.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/voxeet-uxkit-reactnative/voxeet_uxkit_reactnative.framework"
fi
